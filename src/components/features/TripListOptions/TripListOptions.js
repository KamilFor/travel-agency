...
class TripListOptions extends React.Component {
  ...
  handleDuration(type, value) {
    ...
    // TODO - use action dispatcher from props
    if (type === 'from') {
      this.props.changingDurationFrom(type, value);
    } else if (type === 'to') {
      this.props.changingDurationTo(type, value);
    }
  }
...
TripListOptions.propTypes = {
  ...
  changingDurationFrom: PropTypes.func,
  changingDurationTo: PropTypes.func,
};
